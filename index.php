        ...
        <div class="col-md-6 col-lg-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>Rooms with all the luxurious facilities and services for the customers.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>24X7 hour fast and free wifi to all the customers.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>The customer care services is available at all the time to listen the problems of the customers.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>Providing travel accomodation to all the customers to visit the local tourist places and also a pickup from the airport.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>We accept the payment even by the credit cards.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>Providing a large variety of cuisines to the customers for their convinience.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="block-33">
              <div class="vcard d-flex mb-3">
                ...
                <div class="name-text align-self-center">
                  <h2 class="heading">David Copperfield</h2>
                  <span class="meta">Satisfied Customer</span>
                </div>
              </div>
              <div class="text">
                <blockquote>
                  <p>&rdquo; Beautiful ambience. Staff is very polite ,friendly and helpful. Rooms are awEsome , neat and clean. we had a lovely time and great stay with excellent view. &ldquo;</p>
                </blockquote>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="block-33">
              ...
              <div class="text">
                <blockquote>
                  <p>&rdquo; Excellent hotel in the heart of Chandigarh. Beautiful rooms and very good ambience. Just like a mini resort. Would recommend to solo or family travellers. &ldquo;</p>
                </blockquote>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="block-33">
              ...
              <div class="text">
                <blockquote>
                  <p>&rdquo;  It was one of the most beautiful hotel to stay in. I was delighted with the interiors, the hospitality. I will definitely recommend my friends and relatives about this mindblowing property. &ldquo;</p>
                </blockquote>
              </div>
            </div>
