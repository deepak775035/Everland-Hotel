    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="bookastay.php" class="nav-link">Book A Stay</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="block-30 block-30-sm item" style="background-image: url('images/bg_5.jpg');" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-10">
          <span class="subheading-sm">Book A Stay</span>
          <h2 class="heading">Get Your Room</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row block-9">
        <div class="col-md-6 pr-md-5">
          <form name="customers" action="#" method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control px-3 py-3" name="phone_no" placeholder="Phone No.">
            </div>
            ...
            <div>
              ...
              <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                    ...
                    <div class="field-icon-wrap">
                      ...
                      <input type="text" id="checkin_date" name="checkin" class="form-control">
                    </div>
                  </div>
                  <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                    ...
                    <div class="field-icon-wrap">
                      <div class="icon"><span class="icon-calendar"></span></div>
                      <input type="text" id="checkout_date" name="checkout" class="form-control">
                    </div>
                  </div>
                </div>
...
<br>
            ...
            <div class="form-group">
              <input list="room" name="room"> Select Your room
                <datalist id="room">
                      ...
                      <option value="Hollywood Twin">
                      <option value="Suites">
                      <option value="Villas">
                    </datalist>
            </div>
            <div>
              <input type="submit" value="Make a Payment" name="submit"  class="btn btn-primary py-3 px-5">
            </div>
          </form>
  ...
  <?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      mysqli_query($db,"INSERT INTO `customers` VALUES('$_POST[name]','$_POST[email]','$_POST[phone_no]','$_POST[checkin]','$_POST[checkout]','$_POST[room]');");
  ?>
  <script type="text/javascript">
    alert("Room booked get the room number at checkin have a happy stay");
  </script>
  <?php
    }
